...
import org.n52.sos.feeder.baw.utils.IOHelper_01;
...
public class SOSConnector {
    ...
    /** The Constant log. */
    private static final Logger log = Logger.getLogger(SOSConnector.class);
    ...
    public boolean initService() {
        try {
            ...
            paramCon.addParameterShell(ISOSRequestBuilder.GET_CAPABILITIES_ACCEPT_VERSIONS_PARAMETER,
                    this.serviceVersion);
            paramCon.addParameterShell(ISOSRequestBuilder.GET_CAPABILITIES_SERVICE_PARAMETER, "SOS");
    ...
    private XmlObject sendRequest(XmlObject request) throws IOException {
        ...
        try {
            InputStream responseIS = IOHelper_01.sendPostMessage(this.sosURL, requestString);
        	...
        	log.error("Could not send request: " + e.getMessage());
        }
